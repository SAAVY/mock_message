// angular.module('magpieDemo.controllers').controller('navbarController', ['$scope', '$location', function($scope, $location) {
//   $scope.isActive = function(viewLocation) {
//       return viewLocation === $location.path();
//   };
// }]);
//
// angular.module('magpieDemo.controllers').controller('socialMediaController', ['$scope', '$location', '$document',  function($scope, $location, $document) {
//
//   $scope.icons = [
